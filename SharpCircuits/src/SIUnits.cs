...
namespace SharpCircuit.src
{
    ...
    {
        public const double pico = 1E-12;// 0.000000000001 -> 1p
        public const double nano = 1E-9; // 0.000000001 -> 1n
        public const double micro = 1E-6; // 0.000001 -> 1u
        public const double milli = 1E-3; // 0.001 -> 1m
        /*
        ...
        */
        public const double kilo = 1E3; // 1000 -> 1K
        public const double mega = 1E6; // 1000000 -> 1M
        public const double giga = 1E9; // 1000000000 -> 1G
        public const double tera = 1E12;// 1000000000000 -> 1T
